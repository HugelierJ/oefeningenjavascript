...
function myPrint(){
    ...
    while(x<hoeveelGetallen){
        ...
        resultaat.innerHTML += `
        <div class="p-lg-3 col-lg-3">
            <div class="card">
<!--              <img src="https://via.placeholder.com/800x600" class="card-img-top" alt="...">//IS nuttig voor vb een webshop-->
              <div class="card-body">
                <h5 class="card-title">Oefening</h5>
                <p class="card-text">${array1[x]}+${array2[x]} = ${array3[x]}</p>
